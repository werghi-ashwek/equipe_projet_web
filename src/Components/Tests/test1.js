			...
			{showScore ? (
				...
				<div className="Pagecontainer">
				    ...
				    <div className='container'>
						...
						{(showAnswers || timeup) && (
						<Button  className={classes.button} onClick={handleNextQuestion}  style={{backgroundColor: '#a1bbff', color: '#05092e', font: 'Arial, Helvetica, sans-serif'}}  >Next</Button>
						)}
					
				    </div>
				
					{(showAnswers || timeup) &&(
					  <div className="accord"><AccordionEx  text={Questions[currentQuestion].explanation} correctanswer={Questions[currentQuestion].correctanswer}/></div>
					)}
				</div>
